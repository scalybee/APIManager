...
extension APIManager {
    ...
    public func requestDecodable<T:Codable>(url : String, decodeWith: T.Type, httpMethod : APIHTTPMethod, header: [String:String]? = nil, param:[String: Any]? = nil, requestTimeout: TimeInterval = 60, completion : @escaping (Int,Result<T, Error>) -> Void) {
        ...
        manager.requestDecodable(url: url, decodeWith: decodeWith, httpMethod: httpMethod, header: header, param: param, requestTimeout: requestTimeout, completion: completion)
